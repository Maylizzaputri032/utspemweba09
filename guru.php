    ...
    <div class="row no-gutters mt-5">
      <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
        <ul class="nav flex-column ml-3 mb-5">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="karyawan.html"><i class="fas fa-users mr-2"></i></i> Daftar Karyawan</a><hr class="bg-secondary">
          </li>
          <li class="nav-item">
      ...
      <div class="col-md-10 p-5 pt-2"> <!--isi halaman utama/dashboard-->
        <h3><i class="fas fa-chalkboard-teacher mr-2"></i>DAFTAR GURU</h3><hr> <!--tag hr digunakan untuk memberikan garis dibawah tulisan-->

        <a href="" class=" btn btn-primary mb-3"><i class="fas fa-user-plus mr-2"></i>TAMBAH DATA GURU</a>
