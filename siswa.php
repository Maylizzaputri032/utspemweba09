  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-2"> <!--isi halaman utama/dashboard-->
        <h3><i class="fas fa-user-graduate mr-2"></i></i> DAFTAR SISWA</h3><hr> <!--tag hr digunakan untuk memberikan garis dibawah tulisan-->

        <a href="" class=" btn btn-primary mb-3"><i class="fas fa-user-plus mr-2"></i>TAMBAH DATA SISWA</a>
