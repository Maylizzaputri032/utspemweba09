  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-2"> <!--isi halaman utama/dashboard-->
        <h3><i class="fas fa-users mr-2"></i>JADWAL KELAS</h3><hr> <!--tag hr digunakan untuk memberikan garis dibawah tulisan-->

        <a href="" class=" btn btn-primary mb-3"><i class="fas fa-calendar-alt mr-2"></i>TAMBAH DATA JADWAL KELAS</a>
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            <tr>
              <th scope="row">1</th>
              <td>Senin, 15 Juni 2019</td>
              <td>VIII-E</td>
              <td>Matematika</td>
              <td>Pak Darti & Pak Zukar</td>
